...
class RMS:
	def __init__(self,root):
		...
		# --- title --- #
		title=Label(self.root,text="Student Result Managment System",padx=20,compound=LEFT,image=self.logo_dash,font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=0,y=0,relwidth=1,height=50)
		...
		# -- Footer --- #
		footer=Label(self.root,text="Student Result Management System\n By 114,115 & 139",font=("goudy old style",12),bg="#262626",fg="white").pack(side=BOTTOM,fill=X)
		self.update_details()
