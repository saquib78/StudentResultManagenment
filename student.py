...
class studentClass:
	def __init__(self,root):
		...
		txt_addmision = Entry(self.root, textvariable=self.var_a_date, font=("goudy old style", 15, "bold"),bg='lightyellow').place(x=480, y=140, width=200)
