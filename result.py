...
class resultClass:
	def __init__(self,root):
		...
		txt_search_name = Entry(self.root, textvariable=self.var_name, font=("goudy old style", 20, "bold"),bg='lightyellow',state='readonly').place(x=280, y=160, width=320)
		txt_search_course = Entry(self.root, textvariable=self.var_course, font=("goudy old style", 20, "bold"),bg='lightyellow',state='readonly').place(x=280, y=220, width=320)
		txt_search_marks = Entry(self.root, textvariable=self.var_marks, font=("goudy old style", 20, "bold"),bg='lightyellow').place(x=280, y=280, width=320)
		txt_search_full_marks = Entry(self.root, textvariable=self.var_full_marks, font=("goudy old style", 20, "bold"),bg='lightyellow').place(x=280, y=340, width=320)
		...
		btn_add = Button(self.root, text="Clear", font=("times new roman", 15), bg="lightgray",activebackground="lightgray", cursor="hand2",command=self.clear).place(x=430, y=420, width=120, height=35)
